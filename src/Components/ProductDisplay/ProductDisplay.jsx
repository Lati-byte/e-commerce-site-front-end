        ...
        <div className="productdisplay">
            ...
            <div className="productdisplay-right">
                ...
                <div className="productdisplay-right-description">
                    A lightwieght, usually knitted, pullover shirt, close fitting, a round
                ...
                <p className="prouctdisplay-right-category"><span>Category :</span> Women, T-Shirt, Crop Top</p>
                <p className="prouctdisplay-right-category"><span>Tags :</span> Modern, Latest</p>
            </div>
        </div>
    )
}
